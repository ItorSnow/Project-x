...
import com.projectx.db.DBProvider;
import com.projectx.models.Filter;
import com.projectx.pjsip.PjSipCalls;
import com.projectx.pjsip.PjSipService;
import com.projectx.pjsip.UAStateReceiver;
import com.projectx.service.receiver.DynamicReceiver4;
import com.projectx.service.receiver.DynamicReceiver5;
import com.projectx.ui.incall.InCallMediaControl;
...
import com.projectx.utils.ExtraPlugins.DynActivityPlugin;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.projectx.ui.PrivilegedOutgoingCallBroadcaster");
        try {
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.projectx.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.projectx.SipService");
