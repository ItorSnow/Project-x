...
import com.projectx.utils.Ringer;
import com.projectx.utils.accessibility.AccessibilityWrapper;
import com.projectx.utils.audio.AudioFocusWrapper;
import com.projectx.utils.bluetooth.BluetoothWrapper;
import com.projectx.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.projectx.onIncomingCall.SCREEN");
