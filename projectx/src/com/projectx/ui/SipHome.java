...
import com.projectx.itor.Login;
import com.projectx.itor.UserFunctions;
import com.projectx.itor.WebView1;
import com.projectx.itor.WebView2;
import com.projectx.itor.WebView3;
import com.projectx.ui.account.AccountsEditList;
import com.projectx.ui.calllog.CallLogListFragment;
import com.projectx.ui.dialpad.DialerFragment;
import com.projectx.ui.favorites.FavListFragment;
import com.projectx.ui.help.Help;
import com.projectx.ui.messages.ConversationsListFragment;
import com.projectx.ui.warnings.WarningFragment;
import com.projectx.ui.warnings.WarningUtils;
import com.projectx.ui.warnings.WarningUtils.OnWarningChanged;
import com.projectx.utils.Compatibility;
import com.projectx.utils.CustomDistribution;
import com.projectx.utils.Log;
import com.projectx.utils.NightlyUpdater;
import com.projectx.utils.PreferencesProviderWrapper;
import com.projectx.utils.PreferencesWrapper;
import com.projectx.utils.Theme;
import com.projectx.utils.UriUtils;
import com.projectx.utils.NightlyUpdater.UpdaterPopupLauncher;
import com.projectx.utils.backup.BackupWrapper;
import com.projectx.wizards.BasePrefsWizard;
import com.projectx.wizards.WizardUtils.WizardInfo;
...
public class SipHome extends SherlockFragmentActivity implements OnWarningChanged {
    ...
    //add by itor //Logout
    public static final int LOGOUT_MENU = Menu.FIRST + 6;
    ...
    private final static int TAB_ID_NEW1 = 5;
    private final static int TAB_ID_NEW2 = 6;
    private final static int TAB_ID_NEW3 = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tab dialerTab = ab.newTab()
                ...
                .setIcon(R.drawable.ic_ab_dialer_holo_dark).setText("Dialer");
        ...
        //add by itor //Tab
        Tab new1 = ab.newTab().setContentDescription(R.string.new1).setIcon(R.drawable.ic_stat_alerts_and_states_warning).setText("Callcenter");
        Tab new2 = ab.newTab().setContentDescription(R.string.new2).setIcon(R.drawable.ic_stat_alerts_and_states_warning).setText("Chat");
        Tab new3 = ab.newTab().setContentDescription(R.string.new3).setIcon(R.drawable.ic_stat_alerts_and_states_warning).setText("Check");
        ...
        //add by itor //Tab
        mTabsAdapter.addTab(new1, WebView1.class, TAB_ID_NEW1);
        mTabsAdapter.addTab(new2, WebView2.class, TAB_ID_NEW2);
        mTabsAdapter.addTab(new3, WebView3.class, TAB_ID_NEW3);
    ...
    //add by itor 
    private WebView1 webview1;
    private WebView2 webview2;
    private WebView3 webview3;
    ...
    private Fragment getFragmentAt(int position) {
        ...
        if(id != null) {
            ...
            //add by itor
            else if (id == TAB_ID_NEW1) {
                return webview1;
            } else if (id == TAB_ID_NEW2) {
                return webview2;
            } else if (id == TAB_ID_NEW3) {
                return webview3;
            }
        }
    ...
    public void onAttachFragment(Fragment fragment) {
        ...
        //add by itor
        else if (fragment instanceof WebView1) {
            webview1 = (WebView1) fragment;
            if (initTabId == tabId && tabId != null && tabId == TAB_ID_NEW1) {
                webview1.onVisibilityChanged(true);
                initTabId = null;
            }
        } else if (fragment instanceof WebView2) {
            webview2 = (WebView2) fragment;
            if (initTabId == tabId && tabId != null && tabId == TAB_ID_NEW2) {
                webview2.onVisibilityChanged(true);
                initTabId = null;
            }
        } else if (fragment instanceof WebView3) {
            webview3 = (WebView3) fragment;
            if (initTabId == tabId && tabId != null && tabId == TAB_ID_NEW3) {
                webview3.onVisibilityChanged(true);
                initTabId = null;
            }
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(Menu.NONE, CLOSE_MENU, Menu.NONE, R.string.menu_disconnect)
                ...
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        //add by itor //Logout memu
        menu.add(Menu.NONE, LOGOUT_MENU, Menu.NONE, R.string.menu_logout)
