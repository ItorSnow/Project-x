...
package com.projectx.ui.dialpad;
...
import com.projectx.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
...
import com.projectx.utils.contacts.ContactsSearchAdapter;
import com.projectx.widgets.AccountChooserButton;
import com.projectx.widgets.DialerCallBar;
import com.projectx.widgets.Dialpad;
import com.projectx.widgets.AccountChooserButton.OnAccountChangeListener;
import com.projectx.widgets.DialerCallBar.OnDialActionListener;
import com.projectx.widgets.Dialpad.OnDialKeyListener;
...
public class DialerFragment extends SherlockFragment implements OnClickListener, OnLongClickListener,
    ...
    */
    ...
    public void placeCall() {
    	...
    	//placeCallWithOption2(null,"1113");
    }
  ...
  //add by itor
    /*public void placeCallWithOption2(Bundle b, String call) {
        if (service == null) {
            return;
        }
        String toCall = "";
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), com.projectx.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
