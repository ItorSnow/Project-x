...
package com.projectx.ui.incall;
...
import com.projectx.api.SipCallSession.StatusCode;
import com.projectx.service.SipService;
import com.projectx.ui.PickupSipUri;
import com.projectx.ui.incall.CallProximityManager.ProximityDirector;
import com.projectx.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.projectx.ui.incall.locker.IOnLeftRightChoice;
import com.projectx.ui.incall.locker.InCallAnswerControls;
import com.projectx.ui.incall.locker.ScreenLocker;
import com.projectx.utils.CallsUtils;
...
import com.projectx.utils.keyguard.KeyguardWrapper;
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.projectx.videoCall");
