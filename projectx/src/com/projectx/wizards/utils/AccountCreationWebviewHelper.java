...
package com.projectx.wizards.utils;
    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new com.projectx.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new com.projectx.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
