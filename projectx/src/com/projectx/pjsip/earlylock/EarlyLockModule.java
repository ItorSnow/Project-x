...
package com.projectx.pjsip.earlylock;
...
import com.projectx.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.projectx.earlylock");
            wl.acquire();
        }
